...
- Sticky sidebar navigation with active-section tracking and reading progress
- Sections: About, Experience, Skills, Projects, Contact
- Responsive layout with a collapsible menu on mobile
...
src/ui.js           scroll progress, reveal animations, active nav, mobile menu
src/scene.js        Three.js backdrop
src/styles/         design tokens, base, layout, sections and project cards
```
...
Layout inspired by [Yuvraj Singh's portfolio](https://yuvrajgs.github.io/Portfolio/). Colors,
typography, content and code are my own.
